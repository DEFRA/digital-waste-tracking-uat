...
describe('Production Approval Test R02 - Multiple Waste Items', () => {
  ...
  describe('Passed automated assessment for R02', () => {
    it('should pass when a waste movement is supplied with multiple waste items', async () => {
  ...
  describe('Failed automated assessment for R02', () => {
    it('should fail when a waste movement is supplied with a single waste item', async () => {
      const createResponse =
        await globalThis.apis.wasteMovementExternalAPI.receiveMovement(
          wasteReceiptData
        )
