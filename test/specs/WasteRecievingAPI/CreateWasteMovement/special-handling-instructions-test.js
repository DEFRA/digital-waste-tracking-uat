...
describe('Waste Movement Creation with special handling instructions', () => {
  ...
  describe('Successful Creation with special handling instructions', () => {
  ...
  describe('Special handling instructions field length validation', () => {
    it('should successfully reject waste movement creation when the lenght of data entered in special handling instrcuctions exceeds 5000 @allure.label.tag:DWT-323', async () => {
      wasteReceiptData.specialHandlingRequirements =
